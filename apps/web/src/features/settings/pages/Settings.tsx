...
const NOTIFICATION_ITEMS = [
  ...
  { key: 'redAlert',    label: 'Cảnh báo trạm đỏ',       sub: 'Thông báo khi máy còn chạy < 4 giờ' },
  { key: 'yellowAlert', label: 'Cảnh báo trạm vàng',     sub: 'Thông báo khi máy còn chạy 4–8 giờ' },
